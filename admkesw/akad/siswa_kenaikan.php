...
$ke = "$filenya?tapelkd=$tapelkd&kelkd=$kelkd&progkd=$progkd&rukd=$rukd&skkd=$skkd&swkd=$swkd";
	...
	if (empty($tpfkd))
		...
		for ($i=1;$i<=$limit;$i++)
			...
			if ($tcc3 != 0)
				...
				//insert
				mysql_query("INSERT INTO siswa_kelas(kd, kd_siswa, kd_tapel, kd_program, ".
						"kd_kelas) VALUES ".
						"('$xyz', '$x_mskd', '$tpfkd', '$progkd', '$kelasx')");
				}
...
if ($_POST['btnSMP7'])
	...
	if (empty($lulus))
		...
		$ke = "$filenya?tapelkd=$tapelkd&kelkd=$kelkd&progkd=$progkd&rukd=$rukd&smtkd=$smtkd&skkd=$skkd&swkd=$swkd";
		pekem($pesan,$ke);
		exit();
		}
	}
...
if (empty($tapelkd))
	...
	{
	echo '<p>
	<font color="#FF0000"><strong>PROGRAM Belum Dipilih...!</strong></font>
	</p>';
	}
