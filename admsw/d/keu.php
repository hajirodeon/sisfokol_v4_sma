...
<option value="'.$filenya.'?tapelkd='.$tapelkd.'&progkd='.$progkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&jnskd=spi&jenis=SPI">SPI</option>
<option value="'.$filenya.'?tapelkd='.$tapelkd.'&progkd='.$progkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&jnskd=komite&jenis=Komite">Komite</option>
<option value="'.$filenya.'?tapelkd='.$tapelkd.'&progkd='.$progkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&jnskd=les&jenis=LES">LES</option>';
...
if ($tdt != 0)
	{
		...
		echo '<option value="'.$filenya.'?tapelkd='.$tapelkd.'&progkd='.$progkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&jnskd='.$dt_kd.'&jenis='.$dt_nama.'">'.$dt_nama.'</option>';
		}
