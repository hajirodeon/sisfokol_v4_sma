...
if (empty($tapelkd))
	...
	$qjw = mysql_query("SELECT jadwal.*, jadwal.kd AS jkd, m_guru_mapel.*, m_guru.*, ".
							"m_mapel.*, m_kelas.*, m_ruang.*, m_hari.*, m_jam.*, m_program.* ".
							"FROM jadwal, m_guru_mapel, m_guru, m_mapel, ".
							"m_kelas, m_ruang, m_hari, m_jam, m_program ".
							...
							"ORDER BY m_program.program ASC, m_kelas.no ASC, ".
	...
	if ($tjw == 0)
		...
		<td width="1">&nbsp;</td>
		<td width="150"><strong><font color="'.$warnatext.'">Program</font></strong></td>
