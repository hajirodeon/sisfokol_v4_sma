...
if ($_POST['btnBR'])
	...
	//re-direct
	$ke = "pel_entry.php?tapelkd=$tapelkd&smtkd=$smtkd&progkd=$progkd&kelkd=$kelkd&rukd=$rukd";
	xloc($ke);
	exit();
	}
...
if ($_POST['btnNUL'])
	...
	//re-direct
	$ke = "$filenya?tapelkd=$tapelkd&smtkd=$smtkd&progkd=$progkd&kelkd=$kelkd&rukd=$rukd";
	xloc($ke);
	exit();
	}
...
do
	...
	echo '<option value="'.$filenya.'?tapelkd='.$tapelkd.'&smtkd='.$smtkd.'&progkd='.$kea_kd.'">'.$kea_pro.'</option>';
	}
...
do
	...
	echo '<option value="'.$filenya.'?tapelkd='.$tapelkd.'&smtkd='.$smtkd.'&progkd='.$progkd.'&kelkd='.$btkd.'">'.$btkelas.'</option>';
	}
...
do
	...
	echo '<option value="'.$filenya.'?tapelkd='.$tapelkd.'&smtkd='.$smtkd.'&progkd='.$progkd.'&kelkd='.$kelkd.'&rukd='.$ru_kd.'">'.$ru_ru.'</option>';
	}
...
if (empty($tapelkd))
	...
	[<a href="jadwal_prt.php?tapelkd='.$tapelkd.'&smtkd='.$smtkd.'&kelkd='.$kelkd.'&progkd='.$progkd.'&rukd='.$rukd.'" title="Print PDF. . ."><img src="'.$sumber.'/img/print.gif" width="16" height="16" border="0"></a>].
	...
	do
		...
		do
			...
			if ($tdte != 0)
				...
				<br>
				[<a href="pel_entry.php?s=edit&kd='.$dte_kd.'&tapelkd='.$tapelkd.'&smtkd='.$smtkd.'&progkd='.$progkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'"><img src="'.$sumber.'/img/edit.gif" width="16" height="16" border="0"></a>].
				 -
				[<a href="'.$filenya.'?s=hapus&kd='.$dte_kd.'&tapelkd='.$tapelkd.'&smtkd='.$smtkd.'&progkd='.$progkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'"><img src="'.$sumber.'/img/delete.gif" width="16" height="16" border="0"></a>].
				</td>';
				}
			else
				{
